<?php 
    ...
    $i=0;
    $q = "SELECT a.*,b.*,c.* FROM nurse_master a INNER JOIN nurse_det b ON a.n_id=b.n_id INNER JOIN interested_nurse c ON a.n_id=c.n_id WHERE a.active_flag='0' AND c.seen='1'";
